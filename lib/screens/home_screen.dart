...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  Future<void> _fetchRecentMoods() async {
    ...
    try {
      await _mood.fetchRecentMoods();
    } catch (e) {
      debugPrint("Error fetching recent moods: $e");
    } finally {
      if (!mounted) return;
      ...
      builder: (_) => AlertDialog(
        ...
        content: const Text.rich(
          TextSpan(children: [
            ...
            TextSpan(text: "Syncing journals with cloud\n\n", style: TextStyle(color: Colors.red)),
            TextSpan(text: "✅ You can still:\n", style: TextStyle(fontWeight: FontWeight.bold)),
            TextSpan(text: "Create journals\n", style: TextStyle(color: Colors.green)),
            TextSpan(text: "View your mood trends\n", style: TextStyle(color: Colors.green)),
            TextSpan(text: "View your mood history\n\n", style: TextStyle(color: Colors.green)),
            TextSpan(
              text: "ℹ️ Your logged journals will automatically sync when you are back online.",
